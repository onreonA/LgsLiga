...
export default function ExamTrendChart() {
  const getExamTypeColor = (examType: string) => {
    switch (examType) {
      case 'Okul': return '#ef4444';
      case 'Doping': return '#8b5cf6';
      case 'Kaynak': return '#f59e0b';
      case 'Kurs': return '#10b981';
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Sınav Performans Trendi</h3>
      ...
      <div className="h-80">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={mockExamData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
