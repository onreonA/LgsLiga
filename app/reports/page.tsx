...
export default function ReportsPage() {
  ...
  const tabs = [
    ...
    { id: 'subject-performance', name: 'Ders Performansı', icon: 'ri-pie-chart-line' },
    { id: 'book-reading', name: 'Kitap Okuma', icon: 'ri-book-open-line' },
    { id: 'progress-tracking', name: 'İlerleme Takibi', icon: 'ri-line-chart-line' },
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Gelişmiş Performans Raporları</h1>
        <p className="text-gray-600">Günlük çalışma, sınav ve kitap okuma verilerinizin detaylı analizi</p>
      </div>
