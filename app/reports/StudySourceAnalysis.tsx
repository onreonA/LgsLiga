...
const mockSourceData = [
  { source: 'Doping', questions: 485, correct: 412, accuracy: 85, timeSpent: 1240, color: '#8b5cf6' },
  { source: 'Kaynak Kitap', questions: 623, correct: 534, accuracy: 86, timeSpent: 1580, color: '#f59e0b' },
  { source: 'Okul', questions: 392, correct: 314, accuracy: 80, timeSpent: 980, color: '#ef4444' },
  { source: 'Ödev', questions: 347, correct: 285, accuracy: 82, timeSpent: 870, color: '#10b981' }
];
...
export default function StudySourceAnalysis() {
  const totalQuestions = mockSourceData.reduce((sum, item) => sum + item.questions, 0);

  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Kaynak Bazlı Analiz</h3>
          <p className="text-sm text-gray-600">Çalışma kaynaklarının performans karşılaştırması</p>
        </div>
          ...
          <div key={index} className="border border-gray-200 rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="text-right">
                <div className="text-lg font-bold text-gray-900">{source.accuracy}%</div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-gray-50 rounded-lg p-3 text-center">
                <div className="text-lg font-semibold text-gray-900">{source.questions}</div>
                <div className="text-xs text-gray-600">Toplam Soru</div>
              </div>
              <div className="bg-green-50 rounded-lg p-3 text-center">
                <div className="text-lg font-semibold text-green-600">{source.correct}</div>
      ...
      <div className="border-t border-gray-100 pt-6">
        <h4 className="font-semibold text-gray-900 mb-4">Haftalık Kaynak Kullanım Trendi</h4>
        <div className="h-48">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={mockSourceTrend} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              <Bar dataKey="Kaynak Kitap" fill="#f59e0b" radius={[2, 2, 0, 0]} />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-green-50 rounded-xl p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-green-700">En Verimli Kaynak</span>
            </div>
          ...
          <div className="bg-blue-50 rounded-xl p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-sm font-medium text-blue-700">En Çok Kullanılan</span>
            </div>
