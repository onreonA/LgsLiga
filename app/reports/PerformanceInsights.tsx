...
const mockInsights = [
  {
    ...
    description: 'Son 2 haftada matematik performansınız %15 arttı. Bu trendi sürdürün!',
  ...
  },
  {
    ...
    description: 'Sosyal Bilgiler dersinde son 3 sınavda düşüş var. Coğrafya konularına odaklanın.',
  ...
  },
  {
    ...
    description: 'Kaynak kitap kullanımınız %86 doğruluk oranı sağlıyor. Bu kaynağı daha fazla kullanın.',
  ...
  },
  {
    ...
    description: 'En verimli çalışma saatiniz 14:00-16:00 arası. Bu saatleri değerlendirin.',
  ...
  },
  {
    ...
    icon: 'ri-target-line',
    title: 'Hedef Takibi',
    description: 'LGS hedefiniz 450 puan. Mevcut performansla 408 puana ulaşabilirsiniz.',
  ...
  },
  {
    ...
    description: 'Hafta sonları çalışma performansınız %20 düşüyor. Düzenli program oluşturun.',
...
const mockWeeklyGoals = [
  { goal: 'Matematik cebir konusunu bitir', progress: 75, deadline: '3 gün', status: 'on-track' },
  { goal: 'Türkçe paragraf testleri çöz', progress: 45, deadline: '5 gün', status: 'behind' },
  { goal: 'Fen bilimleri deneme sınavı', progress: 90, deadline: '2 gün', status: 'ahead' },
  { goal: 'İngilizce kelime çalışması', progress: 60, deadline: '4 gün', status: 'on-track' }
];
...
export default function PerformanceInsights() {
  const [activeTab, setActiveTab] = useState<'insights' | 'goals' | 'recommendations'>('insights');
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Akıllı Performans Önerileri</h3>
          <p className="text-sm text-gray-600">AI destekli kişiselleştirilmiş öneriler ve hedef takibi</p>
        </div>
          ...
          {mockInsights.map((insight, index) => (
            ...
            >
              <div className="flex items-start space-x-4">
                <div className={`w-10 h-10 bg-${insight.color}-100 rounded-xl flex items-center justify-center flex-shrink-0`}>
                  <i className={`${insight.icon} text-${insight.color}-600 text-xl`}></i>
                </div>
                <div className="flex-1">
                  ...
                  <button className={`text-sm font-medium text-${insight.color}-600 hover:text-${insight.color}-700 cursor-pointer whitespace-nowrap`}>
                    {insight.action} →
                  </button>
                </div>
              </div>
      ...
      {activeTab === 'goals' && (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-4 mb-6">
            <h4 className="font-semibold text-gray-900 mb-2">Bu Haftaki Hedefler</h4>
            <p className="text-sm text-gray-600">Belirlediğiniz hedeflerin ilerleme durumu</p>
          </div>
            ...
            <div key={index} className="border border-gray-200 rounded-xl p-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-500">{goal.deadline} kaldı</span>
                </div>
              </div>
      ...
      {activeTab === 'recommendations' && (
        <div className="space-y-4">
          <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-4 mb-6">
            <h4 className="font-semibold text-gray-900 mb-2">Bugün İçin Önerilen Çalışma Planı</h4>
            <p className="text-sm text-gray-600">Performans analizinize göre özelleştirilmiş plan</p>
          </div>
            ...
            <div key={index} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-all">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-right">
                  <div className="text-lg font-bold text-blue-600">{rec.suggestedTime}</div>
                  <div className={`text-xs px-2 py-1 rounded-full ${
                    rec.difficulty === 'Zor' ? 'bg-red-100 text-red-700' :
                    rec.difficulty === 'Orta' ? 'bg-yellow-100 text-yellow-700' :
                    'bg-green-100 text-green-700'
                  }`}>
                    {rec.difficulty}
                  </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm text-gray-500">Önerilen süre: {rec.suggestedTime}</span>
                </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 text-center">
            ...
            <p className="text-sm text-gray-600 mb-3">Toplam önerilen çalışma süresi: <strong>1 saat 40 dakika</strong></p>
