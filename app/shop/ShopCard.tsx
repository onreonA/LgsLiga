...
export default function ShopCard({ reward, userCoins, onPurchase }: ShopCardProps) {
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-1">
            ...
            <span className="text-lg font-bold text-gray-900">{reward.coin_price.toLocaleString()}</span>
          </div>
          {!canAfford && (
            <span className="text-xs text-red-600 font-medium">Yetersiz bakiye</span>
          )}
        </div>
