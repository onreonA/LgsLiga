  ...
  useEffect(() => {
    const handleAuthCallback = async () => {
      try {
        ...
        setStatus("error");
        setMessage(
          "Beklenmeyen bir hata oluştu. Ana sayfaya yönlendiriliyor...",
        );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center">
      <div className="text-center max-w-md mx-auto px-6">
        <div
          className={`w-20 h-20 bg-gradient-to-br ${getStatusColor()} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-xl ${status === "loading" ? "animate-pulse" : ""}`}
        >
