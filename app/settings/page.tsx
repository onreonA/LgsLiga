...
export default function SettingsPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Motivasyon Ayarları</h1>
        <p className="text-gray-600">Hedeflerini belirle, aile mesajlarını yönet ve kendine mektuplar yaz</p>
      </div>
