...
const mockGoals = [
  {
    id: "1",
    text: "Matematik net sayımı 25'e çıkarmak",
    type: "weekly",
    completed: false,
  ...
  {
    id: "2",
    text: "Her gün en az 1 saat fen çalışmak",
    type: "daily",
    completed: true,
  ...
  {
    id: "3",
    text: "Türkçe paragraf sorularında %80 başarı",
    type: "monthly",
    completed: false,
  ...
  {
    id: "4",
    text: "LGS'ye kadar 500 soru çözmek",
    type: "yearly",
    completed: false,
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Motivasyonunu artıracak hedefler belirle
            </p>
          </div>
          <button
          ...
          {goals.map((goal) => (
            ...
            >
              ...
              <div className="flex-1">
                <p
                  className={`text-gray-900 ${goal.completed ? "line-through opacity-60" : ""}`}
                >
                  {goal.text}
                </p>
                <div className="flex items-center space-x-2 mt-1">
                  <span
                    className={`px-2 py-0.5 text-xs font-medium rounded-full ${getTypeColor(goal.type)}`}
                  >
