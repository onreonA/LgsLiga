...
export const MOTIVATION_MESSAGES = [
  ...
  {
    id: 3,
    message: "Voleybolda nasıl takım halinde güçlüysen, LGS'de de kararlılığınla güçlüsün!",
    type: "teamwork"
  },
  {
    id: 4,
...
export const STREAK_MESSAGES = {
  ...
  broken: [
    ...
    },
    {
      ...
      encouragement: "Voleybolda da bazen top kaçar. Önemli olan bir sonraki vuruş!"
    }
  ],
  motivation: [
    {
...
export const FAMILY_MESSAGES = {
  ...
  reminders: [
    {
      message: "Çalışmayı unutma ama kendini çok yorma da. Sağlığın her şeyden önemli! 🌸",
      type: "health"
    },
    {
